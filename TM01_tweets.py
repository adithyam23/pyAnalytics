...
for tweet in tweepy.Cursor(api.search, q=handle, count=100, lang= "en", since = "2020-07-01").items():
    print(tweet.created_at, tweet.text)
    csvWriter.writerow([tweet.created_at, tweet.text.encode( 'utf-8') ])

handle ='@Adi_red'
for tweet in tweepy.Cursor(api.search, q=handle, count=100, lang= "en", since = "2020-08-01").items():
    print(tweet.created_at, tweet.text)
    csvWriter.writerow([tweet.created_at, tweet.text.encode( 'utf-8') ])
...
# Obtain the sid scores for your review
sid.polarity_scores(review)
review='Amazed with the product'
sid.polarity_scores(review)
